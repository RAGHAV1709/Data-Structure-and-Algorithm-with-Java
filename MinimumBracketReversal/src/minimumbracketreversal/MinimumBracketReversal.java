...
package minimumbracketreversal;
import java.util.*;
public class MinimumBracketReversal {
    //Functions return -1 if brackets can not be balanced
    public static int countBracketReversals(String input){
        ...
        while(!stack.isEmpty()){
            ...
            //if both char1 and char2 are same i.e either they are {{ or }}, then we need only 1 reversal
            else{
                count += 1;
            }
        }
